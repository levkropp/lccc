...
Build flags for SQLite: `CCC_PEEPHOLE_SKIP=signext_move,dead_regs,base_index CCC_DISABLE_PASSES=vectorize,gvn`

Peephole optimizer is now mostly enabled (~22 of 25 sub-passes active).
